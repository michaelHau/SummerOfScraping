...
url = input("Enter the URL of an Instagram post, then press ENTER")
#https://www.instagram.com/p/BlWycAUHHR5/?taken-by=teasocietyofficial

deviceName = input("What is the name of your device (your user directory)?")
...
filteredListOfNames = [] #removes duplicate names

for name in listOfNames:
	if name not in filteredListOfNames:
		filteredListOfNames.append(name)

print(filteredListOfNames[random.randint(0,len(filteredListOfNames))])
